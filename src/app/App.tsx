...
const toggleMusic = () => {
  ...
  const memories = [
    ...
    },
    {
      ...
      description: "ทำไมเธอไม่รอเค้าขอก่อนนะ แต่เคยถามแล้วเธอบอกถ้ารอเค้าขอเป็นแฟนเธอคงเฉาก่อนพอดี ฮ่าๆ แต่สุดท้ายก็เป็นแฟนกันจนได้ เธอบอกว่าด้วยเป็นแฟนคนเรียกด้วย🙂"
    },
    {
